...
import { getSpeakers, createSpeaker, updateSpeaker, deleteSpeaker, uploadImage } from '../api';
...
/**
 * SpeakerPage — full CRUD with backend + image upload
 * @prop {string} title         — page heading
 * @prop {string} addLabel      — add button label
 * @prop {string} accentColor   — accent hex colour
 * @prop {string} dbCategory    — exact category string stored in MongoDB
 * @prop {Array}  initialSpeakers — fallback seed data shown before backend loads
 */
export default function SpeakerPage({
    ...
    /* ─── Save ALL (bulk — used when re-ordering via drag) ─── */
                ...
                {loading ? (
                    <div style={{ display: 'flex', justifyContent: 'center', padding: '60px 0' }}>
                        <div style={{ textAlign: 'center', color: '#64748b' }}>
                            ...
                            <p style={{ fontSize: '14px' }}>Loading from database…</p>
                        </div>
                    </div>
                ) : (
                    <>
                        ...
                        <div className="sp-controls">
                            ...
                            <div className="sp-search-wrap">
                                ...
                                <input className="sp-search-input" placeholder="Search…" value={search} onChange={e => { setSearch(e.target.value); setPage(1); }} />
                            </div>
                        </div>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="sp-td sp-td-bio">
                                                    <div className="sp-bio-preview">{s.bio || '—'}</div>
                                                </td>
                ...
                <div className="sp-modal-overlay" onClick={closeModal}>
                    <div className="sp-modal" onClick={e => e.stopPropagation()} style={{ maxWidth: '520px' }}>
                        ...
                        <div className="sp-modal-body">
                            ...
                            <textarea className="sp-textarea" placeholder="Short biography…" rows={4}
