...
<p>It is with great joy and enthusiasm that we extend a warm invitation to participants from around the world to join us for the <strong>Annual International Conference on Liutex and Vortex Identification (LIUTEXVORTEXSUMMIT2026)</strong>, taking place in <strong>Outram, Singapore, from December 14–16, 2026</strong>.</p>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    {saveStatus === 'error' && (
                        <span style={{ display: 'flex', alignItems: 'center', gap: '6px', background: 'rgba(239,68,68,0.1)', border: '1px solid #ef4444', color: '#dc2626', borderRadius: '8px', padding: '6px 14px', fontSize: '13px', fontWeight: 600 }}>
                            <AlertCircle size={14} /> Save failed – check backend
                        </span>
                    )}
