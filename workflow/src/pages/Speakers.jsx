...
export default function AllSpeakers() {
    ...
    /* ─── Drag-to-sort (within current view) ─── */
                    ...
                    <>
                        ...
                        <div className="sp-controls">
                            ...
                            <div className="sp-search-wrap">
                                ...
                                <input className="sp-search-input" placeholder="Search name, affiliation…" value={search} onChange={e => { setSearch(e.target.value); setPage(1); }} />
                            </div>
                        </div>
                    ...
                    <div className="sp-modal" onClick={e => e.stopPropagation()} style={{ maxWidth: '540px' }}>
                        ...
                        <div className="sp-modal-body">
                            ...
                            <div className="sp-photo-upload-section">
                                ...
                                {form.image && !uploading && <p style={{ margin: '6px 0 0', fontSize: '11px', color: '#10b981', textAlign: 'center' }}>✓ Image uploaded</p>}
                            </div>
