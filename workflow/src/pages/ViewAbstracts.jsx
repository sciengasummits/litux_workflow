    ...
    return (
        <div className="ac2-page">
            ...
            <div className="vr-card">
                ...
                {error && !loading && (
                    <div style={{ padding: '40px', textAlign: 'center', color: '#dc2626', background: '#fef2f2', borderRadius: '10px', margin: '16px' }}>
                                ...
                                {paged.length === 0 ? (
                                    ...
                                    return (
                                        <tr key={uid || idx} className="vr-tr">
                                            ...
                                            <td className="vr-td" style={{ color: '#7c3aed', fontWeight: 500, fontSize: 13 }}>{row.organization || '—'}</td>
                                            <td className="vr-td" style={{ color: '#0f766e', fontSize: 13 }}>{row.topic || '—'}</td>
                                            <td className="vr-td">
                                                {row.fileUrl ? (
