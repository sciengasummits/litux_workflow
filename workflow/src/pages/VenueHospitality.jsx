...
export default function VenueHospitality() {
    ...
    const DEFAULT_HTML = `<p>Rome, the "Eternal City," brims with ancient history, from the Colosseum to the port of Ostia Antica to majestic Vatican City and the Sistine Chapel. Because of its history, art, architecture, and beauty – and perhaps its gelato and pasta! – Rome is one of our most popular cities.</p>
<p>Rome is the capital city and most populated commune of Italy. It is also the administrative center of the Lazio region and of the Metropolitan City of Rome</p>
<p>Elevation: 21 m (69 ft.)<br/>Metropolitan city: Rome Capital</p>
<p>Region: Lazio</p>`;
        ...
        <div className="ac2-page">
            ...
            <div className="ac2-page-header">
                <div className="ac2-title-row">
                    ...
                    <div>
                        <h1 className="ac2-title">Venue Hospitality</h1>
                        <p className="ac2-subtitle">Configure the venue description and location map</p>
                    </div>
                </div>
            </div>

            {/* ══ Section 1 — Venue Description ══ */}
            ...
            <div className="ac2-actions-bar">
                {saved && (
                    <div className="ac2-saved-toast" style={{ background: '#ecfdf5', color: '#047857', border: '1px solid #10b981' }}>
                        <CheckCircle size={15} /> Venue details saved
                    </div>
                )}
                <button className="ac2-submit-btn" onClick={handleSubmit} style={{ background: 'linear-gradient(135deg, #ea580c, #c2410c)', boxShadow: '0 4px 14px rgba(234, 88, 12, 0.4)' }}>
