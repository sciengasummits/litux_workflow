...
export default function WebsiteSections({ section }) {
    ...
    return (
        <div className="id-page">
            ...
            <Section title="🏫 Universities Marquee" color="#8b5cf6"
                ...
                <div style={{ padding: '6px 0' }}>
                    ...
                    <div style={{ marginTop: '20px', background: '#fff7ed', border: '1px solid #fed7aa', borderRadius: '10px', padding: '14px 18px' }}>
                        <p style={{ fontSize: '12px', color: '#92400e', fontWeight: 600, margin: 0 }}>
                            💡 Tip: Sponsors and Media Partners logos, links and descriptions are managed from their own dedicated pages accessible via the sidebar under <strong>Partners</strong>.
                        </p>
                    </div>
                </div>
            </Section>
